...
namespace lab.Manager
{
    ...
    public partial class produto : viewgenerico
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    DropDownListcat.DataSource = ResultadoToDataTable.cat_to_datatable(res);
                    ...
                    if (!string.IsNullOrEmpty(Request.QueryString["cod"]))
                    {
                        ...
                        pro = (dominio.Produto)res.Entidades.ElementAt(0);
                        ...
                        DropDownListcat.SelectedValue = pro.Categoria.Id.ToString();
        ...
        {
            int evade;
            string GRID = "<TABLE class='display' id='GridViewpro'><THEAD>{0}</THEAD><TBODY>{1}</TBODY></TABLE>";
            ...
            {
                pro= (dominio.Produto)res.Entidades.ElementAt(i);
        ...
        {
            string fileToBD = "";
            categoria.Id= Convert.ToInt32(DropDownListcat.SelectedValue);
            pro.Categoria=categoria ;
